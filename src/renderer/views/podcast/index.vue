      ...
      <section v-if="todayPerfered.length > 0">
        ...
        <div class="space-y-3">
          <div
            ...
            class="flex items-center gap-4 p-4 rounded-xl bg-neutral-50 dark:bg-dark-100/50 hover:bg-neutral-100 dark:hover:bg-neutral-800/50 cursor-pointer group transition-all duration-300 animate-item"
