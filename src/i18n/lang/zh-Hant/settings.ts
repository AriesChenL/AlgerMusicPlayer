export default {
  ...
  spectrum: {
    enabled: '頻譜動效',
    enabledDesc: '播放列背景跟隨音樂頻率跳動；關閉則使用輕量動畫',
    attack: '上升速度',
    attackDesc: '數值越大，跳動衝頂越快、鼓點越有衝擊力',
    release: '回落速度',
    releaseDesc: '數值越小，回落越慢越穩，避免畫面抖動',
    bassTilt: '低頻加權',
    bassTiltDesc: '數值越大，大鼓/貝斯等低頻跳動越突出',
    reset: '恢復預設',
    resetDesc: '將上升、回落、低頻加權恢復為預設值',
    resetBtn: '恢復預設'
  },
  basic: {
    themeMode: '主題模式',
    ...
    themeAccent: '強調色',
    themeAccentDesc: '選擇介面主色調',
    themeRadius: '圓角風格',
    themeRadiusDesc: '調整介面圓角大小',
    accentOrange: '橙',
    accentAmber: '琥珀',
    accentTerracotta: '陶土',
    radiusDefault: '預設',
  ...
  playback: {
    ...
    trialFallback: '試聽回退',
    trialFallbackDesc: '當 VIP/無版權歌曲解析失敗時，回退播放官方試聽片段（優於完全無聲）',
    audioDevice: '音訊輸出裝置',
